...
import vrpRep.solutionChecker.constraint.DeterministicMaxWorkTimeLinks;

public class TotalTravelTimeOnLinksTest {

	private VrpRepSolutionChecker solC;
	private Element root;
	private Element experiment;

	private String instanceFile = "./xmlTestObjective/TotalTravelTimeOnLinks/Instance.xml";
	private String solutionFile = "./xmlTestObjective/TotalTravelTimeOnLinks/Solution.xml";
	private String outputFile = "./solutionTestOutput/Objective/TotalTravelTimeOnLinks.xml";
	...
	public void testTrue() {
		// add constraint(s)
		// run experiment
		solC.setObjectiveFunction(new TotalTravelTimeOnLinks());	
		solC.addConstraint(new DeterministicMaxWorkTimeLinks());
