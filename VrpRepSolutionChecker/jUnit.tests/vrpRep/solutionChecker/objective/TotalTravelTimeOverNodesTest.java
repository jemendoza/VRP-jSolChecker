...
public class TotalTravelTimeOverNodesTest {

	private VrpRepSolutionChecker solC;
	private Element root;
	private Element experiment;

	private String instanceFile = "./xmlTestObjective/TotalTravelTimeOverNodes/Instance.xml";
	private String solutionFile = "./xmlTestObjective/TotalTravelTimeOverNodes/Solution.xml";
	private String outputFile = "./solutionTestOutput/Objective/TotalTravelTimeOverNodes.xml";
	...
	public void testTrue() {
		// add constraint(s)
		// run experiment
		solC.setObjectiveFunction(new TotalTravelTimeOverNodes());	
