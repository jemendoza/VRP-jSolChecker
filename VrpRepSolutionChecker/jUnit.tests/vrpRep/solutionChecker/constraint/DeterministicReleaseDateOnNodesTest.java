...
public class DeterministicReleaseDateOnNodesTest {

	private VrpRepSolutionChecker solC;
	private Element root;
	private Element experiment;

	private String instanceFile = "./xmlTest/DeterministicReleaseDateOnNodes/InstanceFalse.xml";
	private String solutionFile = "./xmlTest/DeterministicReleaseDateOnNodes/Solution.xml";
	private String outputFile = "./solutionTestOutput/DeterministicReleaseDateOnNodes.xml";
	...
	public void testTrue() {
		// add constraint(s)
		solC.addConstraint(new DeterministicReleaseDateOnNodes());
		// run experiment
