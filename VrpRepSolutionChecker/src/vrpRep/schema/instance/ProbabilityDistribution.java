...
@XmlRootElement(name = "ProbabilityDistribution")
public class ProbabilityDistribution {

    @XmlElement(required = true)
    protected List<ProbabilityDistribution.Moment> moment;
     ...
     * {@link ProbabilityDistribution.Moment }
     * 
     * 
     */
    public List<ProbabilityDistribution.Moment> getMoment() {
        if (moment == null) {
            moment = new ArrayList<ProbabilityDistribution.Moment>();
        }
        return this.moment;
    }
