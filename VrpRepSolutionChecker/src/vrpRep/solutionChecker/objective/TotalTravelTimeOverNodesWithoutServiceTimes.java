...
/**
 * Calculates vehicle travel time when times are calculated based on node separations and vehicle speed and service times for requests are NOT taken into account
 * @author Maxim HOSKINS, Romain LIENARD, Raphael MOLY and Alexandre RENAUD
 *
 */
public class TotalTravelTimeOverNodesWithoutServiceTimes implements IObjectiveFunction{
